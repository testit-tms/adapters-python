    ...
    for external_id, test_result_id in test_result_ids.items():
        ...
        for uuid, fixtures_container in fixtures_containers.items():
            if external_id in fixtures_container.external_ids:
                ...
                for fixture in fixtures_container.befores:
                    test_result_with_all_fixture_step_results.set_setup_results(fixture.steps)

                for fixture in fixtures_container.afters:
                    test_result_with_all_fixture_step_results.set_teardown_results(fixture.steps)
