...
def lazy_import():
    ...
    globals()['DetailedProjectApiResultWorkflow'] = DetailedProjectApiResultWorkflow
...
class DetailedProjectApiResult(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'workflow': (DetailedProjectApiResultWorkflow,),  # noqa: E501
            'id': (str,),  # noqa: E501
            'name': (str,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, workflow, id, name, is_favorite, is_deleted, global_id, workflow_id, *args, **kwargs):  # noqa: E501
        """DetailedProjectApiResult - a model defined in OpenAPI

        Args:
            workflow (DetailedProjectApiResultWorkflow):
    ...
    @convert_js_args_to_python_args
    def __init__(self, workflow, id, name, is_favorite, is_deleted, global_id, workflow_id, *args, **kwargs):  # noqa: E501
        """DetailedProjectApiResult - a model defined in OpenAPI
