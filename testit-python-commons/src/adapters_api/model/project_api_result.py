...
class ProjectApiResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, name, is_favorite, is_deleted, global_id, workflow_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, name, is_favorite, is_deleted, global_id, workflow_id, *args, **kwargs):  # noqa: E501
        """ProjectApiResult - a model defined in OpenAPI
