...
class AdaptersProjectsProjectIdAttributesSearchPostRequest(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """AdaptersProjectsProjectIdAttributesSearchPostRequest - a model defined in OpenAPI
