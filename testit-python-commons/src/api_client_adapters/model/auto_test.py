...
class AutoTest(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, external_id, project_id, name, global_id, id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, external_id, project_id, name, global_id, id, *args, **kwargs):  # noqa: E501
        """AutoTest - a model defined in OpenAPI
