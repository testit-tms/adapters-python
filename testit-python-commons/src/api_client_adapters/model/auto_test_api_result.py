...
class AutoTestApiResult(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, project_id, name, is_flaky, global_id, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, project_id, name, is_flaky, global_id, *args, **kwargs):  # noqa: E501
        """AutoTestApiResult - a model defined in OpenAPI
