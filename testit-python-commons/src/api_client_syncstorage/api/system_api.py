...
class SystemApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.shutdown_post_endpoint = _Endpoint(
            settings={
                'response_type': (ShutdownResponse,),
                'auth': [],
                'endpoint_path': '/shutdown',
                'operation_id': 'shutdown_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def shutdown_post(
        ...
        **kwargs
        ...
        """Shutdown service  # noqa: E501

         Initiate shutdown of the service.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.shutdown_post(async_req=True)
        >>> result = thread.get()
        ...
        return self.shutdown_post_endpoint.call_with_http_info(**kwargs)
