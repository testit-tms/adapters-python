...
from .step_result import ScenarioStepResult
...
class Autotest:
    ...
    step_results = attrib(default=Factory(typing.List[ScenarioStepResult]))  # noqa: N815
    setup_results = attrib(default=Factory(typing.List[ScenarioStepResult]))  # noqa: N815
